<template>
    <b-container>
        <div>
            <b-navbar toggleable="lg" type="dark" variant="dark" class="fixed-top">
                ...
                <b-collapse id="nav-collapse" is-nav>
                    <b-navbar-nav>
                        <b-nav-item @click="setting()">ตั้งค่าบอท</b-nav-item>
                        <b-nav-item @click="edit()">แก้ไขข้อมูล</b-nav-item>
                    </b-navbar-nav>
        ...
        <b-row>
                    ...
                    <b-row>
                        ...
                        <b-col>
                            <b-list-group>
                                ...
                                <b-list-group-item class="d-flex justify-content-between align-items-center text-white" style="background:#555;">
                                    เดินเงิน
                                    <b-badge variant="danger" pill>{{ settings.bet }} บาท</b-badge>
                                </b-list-group-item>
                            </b-list-group>
                        </b-col>
                    </b-row>
            ...
            <b-col>
                <b-btn block @click="autoroom()" class="rounded-0 btn-lg" variant="danger">
                    เลือกห้องอัติโนมัติ
                </b-btn>
                <b-row>
                    <b-col class="p-3 col-md-12 col-12">
                        ...
                        <b-btn block @click="goto('/Panel/A')" class="rounded-0 btn-sm" variant="secondary">
                            เลือกห้อง A
                            <span class="badge badge-light" id="percentA">100%</span>
                        </b-btn>
                    ...
                    <b-col class="p-3 col-md-12 col-12">
                        ...
                        <b-btn block @click="goto('/Panel/B')" class="rounded-0 btn-sm" variant="secondary">
                            เลือกห้อง B
                            <span class="badge badge-light" id="percentB">100%</span>
                        </b-btn>
                ...
                <b-row>
                    <b-col class="p-3 col-md-12 col-12">
                        ...
                        <b-btn block @click="goto('/Panel/C')" class="rounded-0 btn-sm" variant="secondary">
                            เลือกห้อง C
                            <span class="badge badge-light" id="percentC">100%</span>
                        </b-btn>
                    ...
                    <b-col class="p-3 col-md-12 col-12">
                        ...
                        <b-btn block @click="goto('/Panel/D')" class="rounded-0 btn-sm" variant="secondary">
                            เลือกห้อง D
                            <span class="badge badge-light" id="percentD">100%</span>
                        </b-btn>
                ...
                <b-row>
                    <b-col class="p-3 col-md-12 col-12">
                        ...
                        <b-btn block @click="goto('/Panel/E')" class="rounded-0 btn-sm" variant="secondary">
                            เลือกห้อง E
                            <span class="badge badge-light" id="percentE">100%</span>
                        </b-btn>
                    ...
                    <b-col class="p-3 col-md-12 col-12">
                        ...
                        <b-btn block @click="goto('/Panel/F')" class="rounded-0 btn-sm" variant="secondary">
                            เลือกห้อง F
                            <span class="badge badge-light" id="percentF">100%</span>
                        </b-btn>
      ...
      promiseC
        .then((value) => {
          ...
          if(value.setting === null){
            ...
            this.settings.bet = settings.bet;
            ...
            this.$session.set('setting', settings)
            return true;
          }
        })
        .then(value => {
